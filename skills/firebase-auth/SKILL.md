---
name: firebase-auth
description: Integrates Firebase Authentication into Flutter, native Android, native iOS and React Native apps. Use when setting up auth, managing auth state, implementing email/password or social sign-in, handling auth errors, managing users, or applying security best practices.
routing: manual
