> Adapted from the `display-glasses-with-jetpack-compose-glimmer` skill in [android/skills](https://github.com/android/skills) (Apache-2.0). See `THIRD_PARTY_NOTICES.md`.
