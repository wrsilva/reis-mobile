...
description: Integrates Firebase Crashlytics into Flutter, native Android, native iOS and React Native apps. Use when setting up crash reporting, handling fatal and non-fatal errors, customizing crash reports with keys/logs/user identifiers, or configuring opt-in reporting.
routing: manual
