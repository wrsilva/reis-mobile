...
description: Integrates Firebase App Check into Flutter, native Android, native iOS and React Native apps. Use when setting up App Check, selecting providers per platform, using debug providers during development, enabling enforcement, or applying App Check security best practices.
intents: [security]
