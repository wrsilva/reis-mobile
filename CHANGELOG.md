...
- The package is larger (about 950 KB compressed) and the plugin's fixed context cost grows to about 9,200 tokens per session, since Claude Code loads every skill description.
