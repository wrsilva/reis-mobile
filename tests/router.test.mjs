...
describe('route', () => {
  // Plan §39: the MVP is proven when /reis:review on a Flutter project selects the
  // reviewer agent with the Flutter and security skills.
  it('routes /reis:review on a Flutter project to the MVP agent and skills', async () => {
