...
| Guidance that exists on one stack only | `references/<theme>.md` in `skills/mobile-flutter`, `mobile-android`, `mobile-ios`, `mobile-rn` or `mobile-kmp` | Link it from the skill's topic table |
